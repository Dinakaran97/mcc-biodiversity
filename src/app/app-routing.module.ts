...
const routes: Routes = [
  ...
  { path: 'edit-herbs/:id', component: EditHerbsComponent },
  { path: 'shrubs-list', component: ShrubsListComponent },
  { path: 'edit-shrubs/:id', component: EditShrubsComponent },
  { path: 'liana-list', component: LianaListComponent },
  { path: 'edit-liana/:id', component: EditLainaComponent },
  { path: 'edit-tree/:id', component: EditTreeComponent },
  { path: 'tree-list', component: TreeListComponent },
  { path: 'edit-birds/:id', component: EditBirdsComponent },
  { path: 'birds-list', component: BirdsListComponent },
  { path: 'edit-butterfly/:id', component: EditButterfliesComponent },
